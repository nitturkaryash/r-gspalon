...
export default function Login() {
    ...
    return (_jsxs(Box, { display: "flex", justifyContent: "center", alignItems: "center", minHeight: "100vh", children: [_jsx(CircularProgress, {}), _jsx(Typography, { variant: "body1", sx: { ml: 2 }, children: "Development mode: Redirecting to dashboard..." })] }));
}
