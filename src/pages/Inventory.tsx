...
const Inventory: React.FC = () => {
  ...
  // Debug purchases data when it changes
  useEffect(() => {
    console.log('Inventory component - purchasesQuery data changed:', {
      data: purchasesQuery.data?.length || 0,
      isLoading: purchasesQuery.isLoading,
      error: purchasesQuery.error
    });
  }, [purchasesQuery.data, purchasesQuery.isLoading, purchasesQuery.error]);
