          ...
          <Table>
            ...
            <TableBody>
              {products.map((product) => {
                ...
                const productProfit = calculateProfit(productPrice, productCost);
                const productMargin = calculateProfitMargin(productPrice, productCost);
                
                return (
                  <TableRow 
                    key={product.id}
                    sx={{
                      opacity: productStatus === 'inactive' ? 0.6 : 1,
                    }}
                  >
                    <TableCell>{product.name}</TableCell>
                    <TableCell align="right">{formatCurrency(productPrice)}</TableCell>
                    <TableCell align="right">{formatCurrency(productCost)}</TableCell>
                    ...
                    <TableCell align="right">{product.stock || 0} units</TableCell>
                    <TableCell>
                      <Chip 
